...
const addAppInstallButton = () => {
    ...
    const installButton = id("appInstallBtn"),
        installed = window.localStorage.getItem("isAppInstalled");
    
    // Get the install button.
    /*
    const installButton = document.createElement("button");
    installButton.setAttribute("id", "appInstallButton");
    installButton.setAttribute("type", "button");
    installButton.setAttribute("title", "Install");
    installButton.innerText = "Install";
    document.body.appendChild(installButton);
    */

    if (!!installButton) {
        if (!!installed && installed === "true") id("appInstallBtn").remove();
            ...
            const onInstall = () => {
                ...
                installEvent = null;
                // Set local storage
                window.localStorage.setItem("isAppInstalled", true);
            };
